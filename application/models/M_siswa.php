...
class M_siswa extends CI_Model{
	...
	function get_all_siswa(){
		$hsl=$this->db->query("SELECT tbl_siswa.*,jenis_kelamin FROM tbl_siswa JOIN tbl_jeniskelamin ON siswa_kelas_id=kelas_id");
		return $hsl;
	}
	...
	function siswa_perpage($offset,$limit){
		$hsl=$this->db->query("SELECT tbl_siswa.*,jenis_kelamin FROM tbl_siswa JOIN tbl_jeniskelamin ON siswa_kelas_id=kelas_id limit $offset,$limit");
		return $hsl;
	}
