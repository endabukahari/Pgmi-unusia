...
class M_mapel extends CI_Model{
	...
	function get_all_mapel(){
		$hsl=$this->db->query("SELECT * FROM tbl_angkatan ORDER BY id_mapel DESC");
		return $hsl;
	}
    
	function simpan_mapel($mapel,$keterangan){
		$hsl=$this->db->query("insert into tbl_angkatan(no_angkatan,keterangan_mapel) values ('$mapel','$keterangan')");
		return $hsl;
	}
	...
	function update_mapel($kode,$mapel,$keterangan){
		$hsl=$this->db->query("update tbl_angkatan set no_angkatan='$mapel',keterangan_mapel='$keterangan' where id_mapel='$kode'");
		return $hsl;
	}
	...
	function hapus_mapel($kode){
		$hsl=$this->db->query("delete from tbl_angkatan where id_mapel='$kode'");
		return $hsl;
	}
